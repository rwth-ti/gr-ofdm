...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.connect((self.ofdm_fbmc_receiver_multiuser_cb_0, 0), (self.blks2_error_rate_0, 1))    
        self.connect((self.ofdm_fbmc_receiver_multiuser_cb_0, 1), (self.blks2_error_rate_0_0, 1))    
        self.connect((self.ofdm_fbmc_receiver_multiuser_cb_0, 2), (self.blks2_error_rate_0_0_0, 1))    
        self.connect((self.ofdm_fbmc_receiver_multiuser_cb_0, 3), (self.blks2_error_rate_0_0_1, 1))    
