...
OFDM_API ofdm_corba_multiplex_src_ss_sptr ofdm_make_corba_multiplex_src_ss(std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port);
...
{
  private:
    friend ofdm_corba_multiplex_src_ss_sptr ofdm_make_corba_multiplex_src_ss(std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port);

    ofdm_corba_multiplex_src_ss(std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port);
