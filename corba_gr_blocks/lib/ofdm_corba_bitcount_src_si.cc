...
ofdm_corba_bitcount_src_si_sptr ofdm_make_corba_bitcount_src_si(int istation_id, std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port)
{
  return ofdm_corba_bitcount_src_si_sptr(new ofdm_corba_bitcount_src_si(istation_id, sevent_channel, snameservice_ip, snameservice_port));
}
