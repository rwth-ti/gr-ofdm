...
OFDM_API ofdm_corba_bitcount_src_si_sptr ofdm_make_corba_bitcount_src_si(int istation_id, std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port, bool coding=false);
...
{
  private:
    friend ofdm_corba_bitcount_src_si_sptr ofdm_make_corba_bitcount_src_si(int istation_id, std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port, bool coding);

    ofdm_corba_bitcount_src_si(int istation_id, std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port, bool coding);
