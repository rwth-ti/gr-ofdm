...
set(semilogx1(3),'Color',[0 0 1],'DisplayName','E_s/N_0 = 10 dB');
set(semilogx1(4),'Color',[1 0 1],'DisplayName','E_s/N_0 = 5 dB');
...
%data
 ...
 plot3 = plot (x_20,y_20,'--s', x_15,y_15,'--s',x_10,y_10,'--s',x_5,y_5,'--s','LineWidth',1);
