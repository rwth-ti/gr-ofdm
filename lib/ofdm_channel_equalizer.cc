...
/* $Id: ofdm_channel_equalizer.cc 923 2009-04-21 14:03:45Z auras $ */
...
{
  return ofdm_channel_equalizer::create( vlen );
}
...
create( int vlen )
{
  try
  {
    ofdm_channel_equalizer_sptr tmp(
      new ofdm_channel_equalizer( vlen ) );
  ...
  catch ( ... )
  {
    std::cerr << "[ERROR] Caught exception at creation of "
              << "ofdm_channel_equalizer" << std::endl;
    throw;
  } // catch ( ... )
}
