...
ofdm_channel_equalizer_mimo_2 ::
ofdm_channel_equalizer_mimo_2( int vlen )
  : gr_block(
...
ofdm_channel_equalizer_mimo_2_sptr
ofdm_make_channel_equalizer_mimo_2( int vlen)
{
  return ofdm_channel_equalizer_mimo_2::create( vlen);
}
...
create( int vlen)
{
  try
  {
    ofdm_channel_equalizer_mimo_2_sptr tmp(
      new ofdm_channel_equalizer_mimo_2( vlen) );
  ...
  catch ( ... )
  {
    std::cerr << "[ERROR] Caught exception at creation of "
              << "ofdm_channel_equalizer_mimo_2" << std::endl;
    throw;
  } // catch ( ... )
}
