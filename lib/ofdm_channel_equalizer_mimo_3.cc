...
{
  return ofdm_channel_equalizer_mimo_3::create( vlen);
}
...
create( int vlen)
{
  try
  {
    ofdm_channel_equalizer_mimo_3_sptr tmp(
      new ofdm_channel_equalizer_mimo_3( vlen) );
  ...
  catch ( ... )
  {
    std::cerr << "[ERROR] Caught exception at creation of "
              << "ofdm_channel_equalizer_mimo_3" << std::endl;
    throw;
  } // catch ( ... )
}
