...
{
  return ofdm_channel_estimator_02_sptr( new ofdm_channel_estimator_02( vlen,
      pilot_tones, nondata_block ) );
}

ofdm_channel_estimator_02::ofdm_channel_estimator_02( int vlen,
    const std::vector<int> &pilot_tones,
    const std::vector<int> &nondata_block )

  : gr_sync_block("channel_estimator_02",
           gr_make_io_signature2(2, 2, sizeof(gr_complex)*vlen,
                                       sizeof(char)),
           gr_make_io_signature3(2, 3, sizeof(gr_complex)*vlen,
                                       sizeof(float)*vlen,
...
ofdm_channel_estimator_02::~ofdm_channel_estimator_02()
{
}

void
ofdm_channel_estimator_02::init_LMS_phasetracking(
    const std::vector<int> &pilot_tones,
    const std::vector<int> &nondata_block )
{
...
void
ofdm_channel_estimator_02::init_channel_estimation()
{
...
void
ofdm_channel_estimator_02::set_known_block(
...
int ofdm_channel_estimator_02::work(
    int noutput_items,
...
/*inline*/ void
ofdm_channel_estimator_02::LMS_phasetracking( gr_complex* out )
{
...
/*inline*/ ofdm_channel_estimator_02::block_t
ofdm_channel_estimator_02::channel_estimation(
    const gr_complex* in,
    gr_complex* out,
    float* ctf )
{
