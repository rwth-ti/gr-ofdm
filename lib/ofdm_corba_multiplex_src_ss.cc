...
ofdm_corba_multiplex_src_ss_sptr ofdm_make_corba_multiplex_src_ss(std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port, bool coding)
{
  return ofdm_corba_multiplex_src_ss_sptr(new ofdm_corba_multiplex_src_ss(sevent_channel, snameservice_ip, snameservice_port, coding));
}
...
ofdm_corba_multiplex_src_ss::ofdm_corba_multiplex_src_ss(std::string sevent_channel, std::string snameservice_ip, std::string snameservice_port, bool coding)
  : gr_block(
