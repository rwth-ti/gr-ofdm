...
ofdm_generic_mapper_mimo_bcv_sptr
ofdm_make_generic_mapper_mimo_bcv( int vlen, bool coding )
{
  return ofdm_generic_mapper_mimo_bcv_sptr( new ofdm_generic_mapper_mimo_bcv( vlen,coding ) );
}

ofdm_generic_mapper_mimo_bcv::ofdm_generic_mapper_mimo_bcv (int vlen, bool coding)

  : gr_block("ofdm_generic_mapper_mimo_bcv",
      gr_make_io_signature3(3, 3, sizeof(char),                 // bit stream
                                  sizeof(char)*vlen,            // bitmap
                                  sizeof(char) ),               // trigger
      gr_make_io_signature (2, 2, sizeof(gr_complex)*vlen ) ),  // ofdm blocks
...
void
ofdm_generic_mapper_mimo_bcv::forecast( int noutput_items,
...
int
ofdm_generic_mapper_mimo_bcv::general_work(
    int noutput_items,
...
int
ofdm_generic_mapper_mimo_bcv::noutput_forecast( gr_vector_int &ninput_items,
