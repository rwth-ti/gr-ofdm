...
ofdm_generic_softdemapper_vcf_sptr ofdm_make_generic_softdemapper_vcf (int vlen, bool coding)
{
  return ofdm_generic_softdemapper_vcf_sptr(new ofdm_generic_softdemapper_vcf(vlen,coding));
}

ofdm_generic_softdemapper_vcf::ofdm_generic_softdemapper_vcf (int vlen, bool coding)
  : gr_block("ofdm_generic_softdemapper_vcf",
...
ofdm_generic_softdemapper_vcf::~ofdm_generic_softdemapper_vcf()
{
}
...
void ofdm_generic_softdemapper_vcf::forecast (int noutput_items, gr_vector_int &ninput_items_required)
{
...
int
ofdm_generic_softdemapper_vcf::general_work (
    int noutput_items,
...
int
ofdm_generic_softdemapper_vcf::noutput_forecast( gr_vector_int &ninput_items,
...
ofdm_generic_softdemapper_vcf::get_constellation( int bits, bool coding )
{
