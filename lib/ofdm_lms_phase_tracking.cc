...
ofdm_lms_phase_tracking_sptr ofdm_make_lms_phase_tracking (int vlen,
    const std::vector<int> &pilot_tones,
    const std::vector<int> &data_symbols)
{
  return ofdm_lms_phase_tracking_sptr(new ofdm_lms_phase_tracking(vlen,
      pilot_tones,data_symbols));
}

ofdm_lms_phase_tracking::ofdm_lms_phase_tracking (int vlen,
    const std::vector<int> &pilot_tones,
    const std::vector<int> &data_symbols)
  : gr_sync_block ("ofdm_lms_phase_tracking",
...
int ofdm_lms_phase_tracking::work (int noutput_items,
