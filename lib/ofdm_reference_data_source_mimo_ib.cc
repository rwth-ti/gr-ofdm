...
ofdm_reference_data_source_mimo_ib_sptr ofdm_make_reference_data_source_mimo_ib(const std::vector<int> &ref_data)
{
  return ofdm_reference_data_source_mimo_ib_sptr(new ofdm_reference_data_source_mimo_ib(ref_data));
}


void ofdm_reference_data_source_mimo_ib::forecast(int noutput_items, gr_vector_int &ninput_items_required)
{
  ninput_items_required[0] = 1;
}


ofdm_reference_data_source_mimo_ib::ofdm_reference_data_source_mimo_ib(const std::vector<int> &ref_data)
...
int ofdm_reference_data_source_mimo_ib::general_work(
    int noutput_items,
