...
ofdm_stream_controlled_mux_sptr ofdm_make_stream_controlled_mux(int streamsize)
{
  return ofdm_stream_controlled_mux_sptr(new ofdm_stream_controlled_mux(streamsize));
}


void ofdm_stream_controlled_mux::forecast(int noutput_items, gr_vector_int &ninput_items_required)
{
...
ofdm_stream_controlled_mux::ofdm_stream_controlled_mux(int streamsize)
  : gr_block("stream_controlled_mux",
           gr_make_io_signature2(2, -1, sizeof(unsigned short), streamsize),
           gr_make_io_signature (1, 1, streamsize)),
  d_streamsize(streamsize), d_next_input(0)
{
}

int
ofdm_stream_controlled_mux::general_work(
    int noutput_items,
...
int
ofdm_stream_controlled_mux::noutput_forecast( gr_vector_int &ninput_items,
