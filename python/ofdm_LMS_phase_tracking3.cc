...
ofdm_make_LMS_phase_tracking3( int vlen,
  ...
  int dc_null)
{
  return ofdm_LMS_phase_tracking3::create( vlen, pilot_subc, nondata_blocks,pilot_subcarriers, dc_null);
}
  ...
  int dc_null)
{
  try
  {
    ofdm_LMS_phase_tracking3_sptr tmp(
      new ofdm_LMS_phase_tracking3( vlen, pilot_subc, nondata_blocks, pilot_subcarriers, dc_null) );
