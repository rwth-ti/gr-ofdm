...
corba_push_consumer::corba_push_consumer( std::string snameservice_ip,
  ...
  : d_subscribed(false),
    ...
    /*struct corba_push_consumer_rx::pushconsumer_i :  public virtual POA_CosEventComm::PushConsumer {};*/
    d_pushconsumer_client( pushconsumer_i_create( boost::bind( &corba_push_consumer::store_tx_config, this, _1 ),(ofdm_ti::tx_config_data*)0 ) ),
...
corba_push_consumer::get_latest_id() const
{
  ...
  if (d_tx_config_deque.size() == 0 ) return -1;
  /*
